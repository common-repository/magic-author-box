( function( $ ) {
    ...
    $( document ).ready( function() {
        var context = $( '#mabox-container' );
        context.find( '.maboxfield' ).on( 'change', function() {
        ...
        var elements = context.find( '.maboxfield' ),
            sliders = context.find( '.mabox-slider' ),
            colorpickers = context.find( '.mabox-color' );
        ...
        if ( sliders.length > 0 ) {
            sliders.each( function( $index, $slider ) {
                var input = $( $slider ).parent().find( '.maboxfield' ),
                    max = input.data( 'max' ),
                    min = input.data( 'min' ),
